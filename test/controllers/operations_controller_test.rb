...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create operation' do
    assert_difference('Operation.count') do
      post operations_url,
           params: { operation: { comment: @operation.comment, date: @operation.date, datetime: @operation.datetime, id: @operation.id, marked: @operation.marked, user_id: @operation.user_id } }
    end
